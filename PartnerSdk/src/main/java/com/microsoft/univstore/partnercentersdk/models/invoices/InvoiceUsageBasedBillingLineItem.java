...
// -----------------------------------------------------------------------
// <copyright file="InvoiceUsageBasedBillingLineItem.cs" company="Microsoft">
 ...
 */
public class InvoiceUsageBasedBillingLineItem
    extends InvoiceUsageBasedLineItem
{
    /**
    ...
    {
        return InvoiceLineItemType.BILLING_LINE_ITEMS;
    }
