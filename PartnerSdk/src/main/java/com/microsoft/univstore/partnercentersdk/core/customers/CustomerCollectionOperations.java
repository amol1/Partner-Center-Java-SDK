...
import com.microsoft.univstore.partnercentersdk.core.relationshiprequests.CustomerRelationshipRequestOperations;
...
public class CustomerCollectionOperations
    ...
    implements ICustomerCollectionOperations
{
    /**
     ...
     */
    private ICustomerUsageRecordCollectionOperations usageRecords;

    /**
     * The customer relationship request operations.
     */
    private ICustomerRelationshipRequestOperations relationshipRequest;
     ...
     */
    public CustomerCollectionOperations( IPartnerOperations rootPartnerOperations )
    {
     ...
     */
    @Override
    public ICustomerUsageRecordCollectionOperations getUsageRecords()
    {
     ...
     */
    @Override
    public ICustomerRelationshipRequestOperations getRelationshipRequests()
    {
    ...
    public Customer create( Customer newCustomer )
    {
        ...
        IPartnerServiceProxy<Customer, Customer> partnerServiceProxy =
            ...
            {
            }, this.getPartner(), MessageFormat.format( MicrosoftPartnerSdk.getConfiguration().getApis().get( "CreateCustomer" ).getPath(),
    ...
    public SeekBasedResourceCollection<Customer> get()
    {
        IPartnerServiceProxy<Customer, SeekBasedResourceCollection<Customer>> partnerServiceProxy =
            ...
            {
            }, this.getPartner(), MessageFormat.format( MicrosoftPartnerSdk.getConfiguration().getApis().get( "GetCustomers" ).getPath(),
                                                        Locale.US ) );
    ...
    public SeekBasedResourceCollection<Customer> query( IQuery customersQuery )
    {
        ...
        PartnerServiceProxy<Customer, SeekBasedResourceCollection<Customer>> partnerServiceProxy =
            new PartnerServiceProxy<Customer, SeekBasedResourceCollection<Customer>>( new TypeReference<SeekBasedResourceCollection<Customer>>()
            {
            }, this.getPartner(), MicrosoftPartnerSdk.getConfiguration().getApis().get( "GetCustomers" ).getPath() );
        ...
        if ( customersQuery.getType() == QueryType.SEEK )
        {
            ...
            partnerServiceProxy.getAdditionalRequestHeaders().add( new KeyValuePair<String, String>( MicrosoftPartnerSdk.getConfiguration().getApis().get( "GetCustomers" ).getAdditionalHeaders().get( "ContinuationToken" ),
                                                                                                     customersQuery.getToken().toString() ) );
            partnerServiceProxy.getUriParameters().add( new KeyValuePair<String, String>( MicrosoftPartnerSdk.getConfiguration().getApis().get( "GetCustomers" ).getParameters().get( "SeekOperation" ),
        ...
        else
        {
            if ( customersQuery.getType() == QueryType.INDEXED )
            {
                ...
                partnerServiceProxy.getUriParameters().add( new KeyValuePair<String, String>( MicrosoftPartnerSdk.getConfiguration().getApis().get( "GetCustomers" ).getParameters().get( "Size" ),
            ...
            if ( customersQuery.getFilter() != null )
            {
                ...
                try
                {
                    partnerServiceProxy.getUriParameters().add( new KeyValuePair<String, String>( MicrosoftPartnerSdk.getConfiguration().getApis().get( "GetCustomers" ).getParameters().get( "Filter" ),
