...
// -----------------------------------------------------------------------
// <copyright file="BasePartnerComponent{TContext}.cs" company="Microsoft">
    ...
    implements IPartnerComponent<TContext>
{
     ...
     */
    protected BasePartnerComponent( IPartnerOperations rootPartnerOperations, TContext componentContext )
    {
     ...
     */
    private IPartnerOperations __Partner;

    @Override
    public IPartnerOperations getPartner()
    {
        return __Partner;
    }

    private void setPartner( IPartnerOperations value )
    {
        __Partner = value;
    }
