...
// -----------------------------------------------------------------------
// <copyright file="InvoiceUsageBasedUsageLineItem.cs" company="Microsoft">
 ...
 */
public class InvoiceUsageBasedUsageLineItem
    extends InvoiceUsageBasedLineItem
{
    ...
    {
        return InvoiceLineItemType.USAGE_LINE_ITEMS;
    }
